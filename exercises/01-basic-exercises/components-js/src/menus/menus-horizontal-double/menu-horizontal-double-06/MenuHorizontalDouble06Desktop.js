...
export class MenuHorizontalDouble06Desktop extends LitElement {
  render() {
    return html`
      <div class="main">
        <div class="menusm">
          <menu-social-media-desktop-01-mhd6></menu-social-media-desktop-01-mhd5>
        </div>
        <div class="menu">
...
customElements.define(
  'menu-horizontal-double-06-desktop',
  MenuHorizontalDouble06Desktop
);
