...
// components
import './MenuSocialMediaDesktop01MHD6.js';

const Logo = new URL('/assets/img/logo128.png', import.meta.url).href;

export class MenuHorizontalDouble06TableLaptop extends LitElement {
  render() {
    return html`
      <div class="main">
        <div class="menusm">
          <menu-social-media-desktop-01-mhd6></menu-social-media-desktop-01-mhd6>
        </div>
        <div class="menu">
          ...
          <nav class="menu__nav" id="menu__nav">
            ...
            <ul class="menu__nav-ul-d">
              <a href="./src/login/index.html">login</a>
            </ul>
          </nav>
        </div>
        <div></div>
...
customElements.define(
  'menu-horizontal-double-06-table-laptop',
  MenuHorizontalDouble06TableLaptop
);
