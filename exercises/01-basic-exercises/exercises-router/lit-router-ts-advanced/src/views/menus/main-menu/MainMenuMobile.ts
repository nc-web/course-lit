...
@customElement('main-menu-mobile')
export class MainMenuMobile extends LitElement {
    ...
    return html`
            <div class='menu'>
                ...
                <div class='menu__button'>
                    <a href='/'>
                        <svg class='menu__button_svg' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><title>menu-swap</title><path d="M12,6L7,11H17L12,6M7,13L12,18L17,13H7Z" /></svg>
                    </a>
                </div>
