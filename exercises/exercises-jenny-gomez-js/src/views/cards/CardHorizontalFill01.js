            ...
            <article class='card'>
                <div class='card__left'>
                    <div class='card__left-header'>
                        <h3 class='card__left-header-title'> ANDRES GIRALDO ARENAS</h3>
                    </div>
                    <div class='card__left-body'>
                        <p class='card__left-body-text'>Lorem Ipsum es simplemente el texto de relleno de las imprentas y archivos de texto.</p>
                    </div>
                ...
                <div class='card__right'>
                    <div class='card__right-container-img'>
                        <img class='card__right-container-img-img' src=${Jenny} alt='Jenny' width='150'/>
                    </div>
