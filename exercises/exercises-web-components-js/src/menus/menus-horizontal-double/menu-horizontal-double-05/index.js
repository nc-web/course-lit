...
// Components
import './MenuHorizontalDouble05Mobile.js';
import './MenuHorizontalDouble05TableLaptop.js';
import './MenuHorizontalDouble05Desktop.js';

export class IndexMenuHorizontalDouble05 extends LitElement {
  render() {
    if (window.screen.width > 1024) {
      return html` <menu-horizontal-double-05-desktop>
      ...
      </menu-horizontal-double-05-desktop>`;
    }
    if (window.screen.width > 425 && window.screen.width <= 1024) {
      return html` <menu-horizontal-double-05-table-laptop>
...
customElements.define(
  'index-menu-horizontal-double-05',
  IndexMenuHorizontalDouble05
);
