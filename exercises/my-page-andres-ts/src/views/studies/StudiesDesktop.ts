...
const CSS3 = new URL('../../../assets/img/cc3.png', import.meta.url).href;
      ...
      <section class="section" id="section-studies">
        <div class="section__cards">
          ...
          <div class="section__cards03">
            <card-studies-01></card-studies-01>
          </div>

          <div class="section__cards-04">
            <img class="section__cards-03-img" src=${JS} alt="Javascript" />
          </div>
