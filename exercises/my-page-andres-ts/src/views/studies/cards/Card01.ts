...
const Profile = new URL(
  '../../../../../assets/img/andres-01.png',
  import.meta.url
).href;

@customElement('card-studies-01')
      ...
      <article class="card">
        <div class="card__header">
          <div class="card__header-containerimg">
            <img
              class="card__header-containerimg-img"
              src=${Profile}
              alt="Profile"
            />
          </div>
          <div class="card__header-containertext">
            ...
            <div class="card__header-containertext-icon">
              ...
              <svg
                class="card__header-containertext-icon-02"
                style="width:24px;height:24px"
                viewBox="0 0 24 24"
              >
                <path
              ...
              <svg
                class="card__header-containertext-icon-03"
                style="width:24px;height:24px"
                viewBox="0 0 24 24"
              >
                <path
              ...
              <svg
                class="card__header-containertext-icon-04"
                style="width:24px;height:24px"
                viewBox="0 0 24 24"
              >
                <path
