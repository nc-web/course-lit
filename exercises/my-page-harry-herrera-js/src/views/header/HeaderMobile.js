                ...
                <div class="section__main">
                    ...
                    <div class="section__body">
                        <div class="section__body-01">
                            <img class="section__body-01-img" src=${OWC} alt='OWC'/>
                        </div>

                        <div class="section__body-02">
                            <img class="section__body-02-img" src=${OWC} alt='OWC'/>
                        </div>
                    </div>

                    <div class="section__footer">
                        <div class="section__footer-04">
                            <img class="section__footer-04-img" src=${OWC} alt='OWC'/>
                        </div>

                        <div class="section__footer-05">
                            <img class="section__footer-05-img" src=${OWC} alt='OWC'/>
                        </div>
                    </div>
                </div>
            </section> 
