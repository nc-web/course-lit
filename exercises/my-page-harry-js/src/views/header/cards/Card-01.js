...
// Img
import Lit from '/img/harry.webp'
...
export class Card01 extends LitElement{
            ...
            <article class="card">
                <div class="card__header">
                    <div class="card__header-containerimg">
                        <img class="card__header-containerimg-img" src=${Lit} />
                    </div>
                    <div class="card__header-containertext">
                        <h4 class="card__header-containertext-title">Harrinson Herrera</h4>
                        <p class="card__header-containertext-text">
                            Desarrollador Web
                        </p>
                ...
                <div class="card__footer">
                    ...
                    <button class="card__footer-button-right">
                        <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                            <path fill="#ffffff" d="M4,15V9H12V4.16L19.84,12L12,19.84V15H4Z" />
                        </svg>
                    </button>
                </div>
            </article>
    ...
    static styles = css`
        ...
        .card__header-containertext-text{
            color: #424242;
        }
