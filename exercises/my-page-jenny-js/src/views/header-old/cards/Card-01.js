...
export class Card01 extends LitElement {
            ...
            <article class='card'> 
                <div class='card__header'>
                    ...
                    <div class='card__header-containertext'>
                        <h4 class='card__header-containertext-title'> Jenny Alexandra Gómez Parra </h4>
                        <p class='card__header-containertext-subtitle'> Layout Web </p>
                ...
                <div class='card__footer'>
                    ...
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                        <path fill="white" d="M22,12A10,10 0 0,1 12,22A10,10 0 0,1 2,12A10,10 0 0,1 12,2A10,10 0 0,1 22,12M14,7L9,12L14,17V7Z" />
                    </svg>
                    </button>
                    <button class='card__footer-button-right'>
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                        <path fill="white" d="M2,12A10,10 0 0,1 12,2A10,10 0 0,1 22,12A10,10 0 0,1 12,22A10,10 0 0,1 2,12M10,17L15,12L10,7V17Z" />
                    </svg>
                    </button>
                </div>
            </article>
    ...
    static styles = css`
        ...
        .card {
            ...
            padding: 1rem;
            border-radius: 1rem;
            background: linear-gradient(135deg,#EEEEEE, #BDBDBDBD);
        ...
        .card__footer-button-left:hover {
            ...
            filter: drop-shadow(0 0 .1rem #18FFFF );
        }
