...
export class Card01 extends LitElement {
    ...
    render() {
        ...
        <article class='card'>
            ...
            <div class='card__body'>
                <h2 class='card__body-title'>ANDRES</h2>
                <p class='card__body-subtitle' >Developer Full Stack</p>
            </div>
            <div class='card__footer'>
                ...
                <svg class='card__footer-svg' style="width:30px;height:30px" viewBox="0 0 24 24">
    ...
    static styles = css`
        ...
        .card {
            width: 18rem;
            padding: 1.2rem;
            background: linear-gradient(160deg, #673AB7, #4527A0);
            border-radius: 1rem ;
        }
        ...
        .card__footer-btn-left {
            ...
            height: 3rem;
            border-radius: 50%;
            background: linear-gradient(180deg, #FFCDD2, 20%, #EF5350);
        ...
        .card__footer-btn-right {
            ...
            height: 3rem;
            border-radius: 50%;
            background: linear-gradient(180deg, #A5D6A7, 20%, #43A047);
            box-shadow: .1rem .1rem .1rem .1rem rgba(0, 0, 0, 0.2);
            border-style: none;
            cursor: pointer;
        }
