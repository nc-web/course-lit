        ...
        <article class='card'>
            <div class='card__header'>
                <div class='card__header-containerimg'>
                    <img class='card__header-containerimg-img' src=${Jenny} alt='Jenny' width='10' />
                </div>

                <div class='card__header-containertext'>
                    <h4 class='card__header-containertext-title'> Jenny Gómez </h4>
                    <p class='card__header-containertext-subtitle'> Desarrollo Web </p>

                    <div class='card__header-containertexrt-icon'> 
                        ...
                        <svg class="card__header-containertext-icon-4" style="width:24px;height:24px" viewBox="0 0 24 24"><title>phone</title>
            ...
            <div class='card__footer'>
                <button class='card__footer-button-left'>
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24"> >
                        <path fill="#009fe1" d="M22,12A10,10 0 0,1 12,22A10,10 0 0,1 2,12A10,10 0 0,1 12,2A10,10 0 0,1 22,12M14,7L9,12L14,17V7Z" />
                    </svg>
                </button>
                <button class='card__footer-button-righ'>
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24"><title>arrow-right-drop-circle</title>
                        <path fill="#009fe1" d="M2,12A10,10 0 0,1 12,2A10,10 0 0,1 22,12A10,10 0 0,1 12,22A10,10 0 0,1 2,12M10,17L15,12L10,7V17Z" />
                    </svg>
                </button>
            </div>
        </article>
